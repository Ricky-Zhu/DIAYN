...
# if sys.argv[0].split('/')[-1] in ["train_ddpg.py", "visitation_plot.py", "vis_fetch.py","plot_explored_area.py"]:
...
task_types = ['Maze', 'Maze1', 'Push', 'Fall', 'Block', 'BlockMaze', 'Empty']
...
#     top_down = True
# else:
top_down = False  # turn true the observation will be 104 dim
